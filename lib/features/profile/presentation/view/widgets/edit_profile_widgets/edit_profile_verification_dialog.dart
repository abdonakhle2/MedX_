...
class EditProfileVerificationDialog extends StatefulWidget {
  final User user;

  const EditProfileVerificationDialog({super.key, required this.user});

  @override
  State<EditProfileVerificationDialog> createState() =>
      _EditProfileVerificationDialogState();
}

class _EditProfileVerificationDialogState
    extends State<EditProfileVerificationDialog> {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          localeText.profileVerificationDocuments,
