...
class EditProfileContactDialog extends StatefulWidget {
  final User user;

  const EditProfileContactDialog({super.key, required this.user});

  @override
  State<EditProfileContactDialog> createState() =>
      _EditProfileContactDialogState();
}

class _EditProfileContactDialogState extends State<EditProfileContactDialog> {
